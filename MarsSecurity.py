...
def fetch_mars_rover_photos(api_key, sol=1000, date=100, page=1):
...
def mars_rover_photo_interface(sol,date,page):
    """
    ...
    api_key = "36PJ0s4qF2bak3DEzoaxMidn7tYjYtyA55xBVDik" # 已替换为申请API
    data = fetch_mars_rover_photos(api_key, sol=sol,date=date,page=page)
    print(data)
    if data:
